...
\input{content/basics/pipeline.tex}
...
\input{content/basics/learning.tex}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{assets/basics/confusion_terminology.png}
  \caption{Terms around machine learning}
  \label{fig:1_ml_terminology}
\end{figure}


\input{content/basics/ds_process.tex}
\input{content/basics/challenges.tex}
