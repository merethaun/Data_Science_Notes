...
To investigate the raw data further, let's visualize it. More specifically, we're going to visualize the distributions of the different features. Figure \ref{fig:2_distr_visualization} shows examplary plots.
\begin{itemize}
...
\begin{figure}[H]
  ...
  \subcaptionbox{Distribtion of categorical features}{
    \includegraphics[width=0.75\textwidth]{assets/basics/etl.png}% TODO: adjust
  }
  \\\vspace*{0.5cm}
  \subcaptionbox{Distribtion of numerical (continuous) features}{
    \includegraphics[width=0.75\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
...
\begin{figure}[H]
  ...
  \subcaptionbox{Good approximation (14 bins)}{
    \includegraphics[width=0.4\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
  \\\vspace*{0.5cm}
  \subcaptionbox{Underfitting (3 bins)}{
    \includegraphics[width=0.4\textwidth]{assets/basics/etl.png}% TODO: adjust
  }\hspace*{0.5cm}
  \subcaptionbox{Overfitting (60 bins)}{
    \includegraphics[width=0.4\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
...
\begin{figure}[H]
  ...
  \subcaptionbox{Uniform}{
    \includegraphics[width=0.3\textwidth]{assets/basics/etl.png}% TODO: adjust
  }
  \hspace*{0.015\textwidth}
  \subcaptionbox{Unimodal, normal}{
    \includegraphics[width=0.3\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
  \hspace*{0.015\textwidth}
  \subcaptionbox{Unimodal, skewed right}{
    \includegraphics[width=0.3\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
  \\\vspace*{0.5cm}
  \subcaptionbox{Unimodal, skewed left}{
    \includegraphics[width=0.3\textwidth]{assets/basics/etl.png}% TODO: adjust
  }
  \hspace*{0.015\textwidth}
  \subcaptionbox{Exponential}{
    \includegraphics[width=0.3\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
  \hspace*{0.015\textwidth}
  \subcaptionbox{Multimodal}{
    \includegraphics[width=0.3\textwidth]{assets/basics/elt.png}% TODO: adjust
  }
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{assets/basics/etl.png}% TODO: adjust
